...
for graph_type in best_fitness mutation_rate; do # mutation_rate

# merged stat and ab
s_p="all_zips/comb_graphs/"${graph_type}
bi_arr=("fit_stat_0" "fit_bi_1_5000" "fit_bi_1_1000" "fit_bi_1_500" "fit_bi_1_50")
pm_arr=("fit_stat_0" "fit_pm_5000" "fit_pm_1000" "fit_pm_500" "fit_pm_50")
...
dyn_arr=("_bi_1_5" "_bi_1_50" "_bi_1_500" "_bi_1_5000" "_bi_5_5" "_bi_5_50" "_bi_5_500" "_bi_5_5000")
...
montage -geometry 1280x1440 -tile 8x4 ${n_arr[@]} ${p}/${graph_type}/LO/merged/LO_${graph_type}.png
